    ...
    return (
        <div className='flex justify-center items-center h-full my-24 '>
            <div className='flex justify-center items-center h-full'>
                <p className='text-7xl font-semibold'>C</p>
                <p className='w-10 h-10 border-8 rounded-full animate-spin border-dashed mt-6 border-green-400'> </p>
                <p className='text-7xl font-semibold'>mingS</p>
                <p className='w-10 h-10 border-8 rounded-full animate-spin border-dashed mt-6 border-green-400 mx-1'> </p>
                <p className='w-10 h-10 border-8 rounded-full animate-spin border-dashed mt-6 border-green-400'> </p>
                <p className='text-7xl font-semibold'>n</p>
